...
$servername = "capstonespring2025.duckdns.org";  // Your server host
$username = "Capstone";                          // Your DB username
$password = "Capstone123";                       // Your DB password
$database = "healthmate";                        // Your DB name
$port = 3306;
